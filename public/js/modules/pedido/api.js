...
async function buscarAgendamento() {
    ...
    try {
        const response = await fetch(`/askyuagendamento/${usuarioId}/${agendamentoId}`, {
            method: "GET"
        });
...
async function buscarClienteView(clienteId) {
    try {
        const response = await fetch(`/askyucliente-view/${clienteId}`, {
            method: "GET"
        });
...
async function buscarClientePorId(novoClienteId) {
    ...
    try {
        const response = await fetch(`/askyuclientes/${novoClienteId}/buscarUm`, {
            method: "GET"
        });
...
async function buscarEnderecoPorId() {
    ...
    try {
        const response = await fetch(`/askyuenderecos/buscar-um/${usuarioId}/${enderecoId}`, {
            method: "GET"
        });
...
async function buscarTelefonePorId() {
    ...
    try {
        const response = await fetch(`/askyutelefone/buscar-um/${usuarioId}/${telefoneId}`, {
            method: "GET"
        });
...
async function buscarEnderecoPorClienteId(nomeModal) {
    ...
    try {
        const response = await fetch(`/askyuenderecos/${usuarioId}/${clienteId}`, {
            method: "GET"
        });
...
async function buscarTelefonePorClienteId(nomeModal) {
    ...
    try {
        const response = await fetch(`/askyutelefone/${usuarioId}/${clienteId}`, {
            method: "GET"
        });
...
async function buscarClientesPorResponsavelId(nomeModal) {
    ...
    try {
        const response = await fetch(`/askyuclientes/por-responsavel/${usuarioId}/${responsavelId}`, {
            method: "GET"
        });
...
async function buscarClientesPorNome(clienteNome) {
    ...
    try {
        const response = await fetch(`/askyuclientes/${usuarioId}/filtro-nome?nome=${clienteNome}`, {
            method: "GET"
        });
...
async function atualizarDadosCliente(clienteId) {
    ...
    try {
        const response = await fetch(`/askyuclientes/${clienteId}`, {
            method: "PUT",
            headers: {
...
async function atualizarEnderecoAgendamento(enderecoId) {
    ...
    try {
        const response = await fetch(`/askyuagendamento/atualizar-endereco/${usuarioId}/${agendamentoId}/${enderecoId}`, {
            method: "PATCH"
        });
...
async function atualizarTelefoneAgendamento(telefoneId) {
    ...
    try {
        const response = await fetch(`/askyuagendamento/atualizar-telefone/${usuarioId}/${agendamentoId}/${telefoneId}`, {
            method: "PATCH"
        });
...
async function atualizarEndereco(){
    ...
    try {
        const response = await fetch(`/askyuenderecos/${usuarioId}/${enderecoId}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json"
            },
...
async function atualizarTelefone(){
    ...
    try {
        const response = await fetch(`/askyutelefone/${usuarioId}/${telefoneId}?numero=${numero}`, {
            method: "PATCH",
        });
...
async function cadastrarClienteModal() {
    ...
    try {
        const response = await fetch(`/askyuclientes`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function criarPedido() {
    ...
    try {
        const response = await fetch(`/askyuagendamento`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function cadastrarEnderecoModal(){
    ...
    try {
        const response = await fetch(`/askyuenderecos/${usuarioId}`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function cadastrarTelefoneModal() {
    ...
    try {
        const response = await fetch(`/askyutelefone`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function buscarEtapas() {
    ...
    try {
        ...
        const response = await fetch(`/askyuetapas/${usuarioId}`, {
            method: "GET"
        });
...
async function buscarStatusAgendamento(){
    ...
    try{
        ...
        const response = await fetch(`/askyuagendamento-log/${usuarioId}/${agendamentoId}`, {
            method: "GET"
        });
...
async function desativarPedidosPorAgendamento(){
    ...
    try{
        var response = await fetch(`/askyupedido/excluir-por-agendamento/${usuarioId}/${agendamentoId}`,{
            method: "DELETE"
        })
...
async function desativarAgendamento() {
    ...
    try{
        var response = await fetch(`/askyuagendamento/${usuarioId}/${agendamentoId}`, {
            method: "DELETE"
        })
...
async function desativarTelefone(){
    ...
    try{
        var response = await fetch(`/askyutelefone/${usuarioId}/${telefoneId}`, {
            method: "DELETE"
        })
...
async function desativarEndereco(){
    ...
    try{
        var response = await fetch(`/askyuenderecos/${usuarioId}/${enderecoId}`, {
            method: "DELETE"
        })
...
async function desativarCliente() {
    ...
    try{
        var response = await fetch(`/askyuclientes/${usuarioId}/${clienteId}`, {
            method: "PATCH"
        })
