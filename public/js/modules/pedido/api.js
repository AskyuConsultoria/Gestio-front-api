...
async function buscarAgendamento() {
    ...
    try {
        const response = await fetch(`http://localhost:8080/askyu/askyu/agendamento/${usuarioId}/${agendamentoId}`, {
            method: "GET"
        });
...
async function buscarClienteView(clienteId) {
    try {
        const response = await fetch(`http://localhost:8080/askyu/askyu/cliente-view/${clienteId}`, {
            method: "GET"
        });
...
async function buscarClientePorId(novoClienteId) {
    ...
    try {
        const response = await fetch(`http://localhost:8080/askyu/askyu/clientes/${novoClienteId}/buscarUm`, {
            method: "GET"
        });
...
async function buscarEnderecoPorId() {
    ...
    try {
        const response = await fetch(`http://localhost:8080/askyu/askyu/enderecos/buscar-um/${usuarioId}/${enderecoId}`, {
            method: "GET"
        });
...
async function buscarTelefonePorId() {
    ...
    try {
        const response = await fetch(`http://localhost:8080/askyu/askyu/telefone/buscar-um/${usuarioId}/${telefoneId}`, {
            method: "GET"
        });
...
async function buscarEnderecoPorClienteId(nomeModal) {
    ...
    try {
        const response = await fetch(`http://localhost:8080/askyu/askyu/enderecos/${usuarioId}/${clienteId}`, {
            method: "GET"
        });
...
async function buscarTelefonePorClienteId(nomeModal) {
    ...
    try {
        const response = await fetch(`http://localhost:8080/askyu/askyu/telefone/${usuarioId}/${clienteId}`, {
            method: "GET"
        });
...
async function buscarClientesPorResponsavelId(nomeModal) {
    ...
    try {
        const response = await fetch(`http://localhost:8080/askyu/askyu/clientes/por-responsavel/${usuarioId}/${responsavelId}`, {
            method: "GET"
        });
...
async function buscarClientesPorNome(clienteNome) {
    ...
    try {
        const response = await fetch(`http://localhost:8080/askyu/askyu/clientes/${usuarioId}/filtro-nome?nome=${clienteNome}`, {
            method: "GET"
        });
...
async function atualizarDadosCliente(clienteId) {
    ...
    try {
        const response = await fetch(`http://localhost:8080/askyu/askyu/clientes/${clienteId}`, {
            method: "PUT",
            headers: {
...
async function atualizarEnderecoAgendamento(enderecoId) {
    ...
    try {
        const response = await fetch(`http://localhost:8080/askyu/askyu/agendamento/atualizar-endereco/${usuarioId}/${agendamentoId}/${enderecoId}`, {
            method: "PATCH"
        });
...
async function atualizarTelefoneAgendamento(telefoneId) {
    ...
    try {
        const response = await fetch(`http://localhost:8080/askyu/askyu/agendamento/atualizar-telefone/${usuarioId}/${agendamentoId}/${telefoneId}`, {
            method: "PATCH"
        });
...
async function atualizarEndereco(){
    ...
    try {
        const response = await fetch(`http://localhost:8080/askyu/askyu/enderecos/${usuarioId}/${enderecoId}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json"
            },
...
async function atualizarTelefone(){
    ...
    try {
        const response = await fetch(`http://localhost:8080/askyu/askyu/telefone/${usuarioId}/${telefoneId}?numero=${numero}`, {
            method: "PATCH",
        });
...
async function cadastrarClienteModal() {
    ...
    try {
        const response = await fetch(`http://localhost:8080/askyu/askyu/clientes`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function criarPedido() {
    ...
    try {
        const response = await fetch(`http://localhost:8080/askyu/askyu/agendamento`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function cadastrarEnderecoModal(){
    ...
    try {
        const response = await fetch(`http://localhost:8080/askyu/askyu/enderecos/${usuarioId}`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function cadastrarTelefoneModal() {
    ...
    try {
        const response = await fetch(`http://localhost:8080/askyu/askyu/telefone`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function buscarEtapas() {
    ...
    try {
        ...
        const response = await fetch(`http://localhost:8080/askyu/askyu/etapas/${usuarioId}`, {
            method: "GET"
        });
...
async function buscarStatusAgendamento(){
    ...
    try{
        ...
        const response = await fetch(`http://localhost:8080/askyu/askyu/agendamento-log/${usuarioId}/${agendamentoId}`, {
            method: "GET"
        });
...
async function desativarPedidosPorAgendamento(){
    ...
    try{
        var response = await fetch(`http://localhost:8080/askyu/askyu/pedido/excluir-por-agendamento/${usuarioId}/${agendamentoId}`,{
            method: "DELETE"
        })
...
async function desativarAgendamento() {
    ...
    try{
        var response = await fetch(`http://localhost:8080/askyu/askyu/agendamento/${usuarioId}/${agendamentoId}`, {
            method: "DELETE"
        })
...
async function desativarTelefone(){
    ...
    try{
        var response = await fetch(`http://localhost:8080/askyu/askyu/telefone/${usuarioId}/${telefoneId}`, {
            method: "DELETE"
        })
...
async function desativarEndereco(){
    ...
    try{
        var response = await fetch(`http://localhost:8080/askyu/askyu/enderecos/${usuarioId}/${enderecoId}`, {
            method: "DELETE"
        })
...
async function desativarCliente() {
    ...
    try{
        var response = await fetch(`http://localhost:8080/askyu/askyu/clientes/${usuarioId}/${clienteId}`, {
            method: "PATCH"
        })
