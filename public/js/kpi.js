async function buscarRelatorioCliente(usuarioId) {
    try {
        const resposta = await fetch(`http://10.0.1.226:8080/askyu/clientes/${usuarioId}/relatorio-kpi`, {
            method: "GET"
        });
...
async function buscarRelatorioPedido(usuarioId) {
    try {
        const resposta = await fetch(`http://10.0.1.226:8080/askyu/pedido/${usuarioId}/relatorio-kpi`, {
            method: "GET"
        });
