async function buscarRelatorioCliente(usuarioId) {
    try {
        const resposta = await fetch(`http://localhost:8080/askyu/askyu/clientes/${usuarioId}/relatorio-kpi`, {
            method: "GET"
        });
...
async function buscarRelatorioPedido(usuarioId) {
    try {
        const resposta = await fetch(`http://localhost:8080/askyu/askyu/pedido/${usuarioId}/relatorio-kpi`, {
            method: "GET"
        });
