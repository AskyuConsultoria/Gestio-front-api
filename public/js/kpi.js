async function buscarRelatorioCliente(usuarioId) {
    try {
        const resposta = await fetch(`http://10.18.34.59:8080/clientes/${usuarioId}/relatorio-kpi`, {
            method: "GET"
        });
...
async function buscarRelatorioPedido(usuarioId) {
    try {
        const resposta = await fetch(`http://10.18.34.59:8080/pedido/${usuarioId}/relatorio-kpi`, {
            method: "GET"
        });
