async function buscarRelatorioCliente(usuarioId) {
    try {
        const resposta = await fetch(`http://192.168.15.3:8080/clientes/${usuarioId}/relatorio-kpi`, {
            method: "GET"
        });
...
async function buscarRelatorioPedido(usuarioId) {
    try {
        const resposta = await fetch(`http://192.168.15.3:8080/pedido/${usuarioId}/relatorio-kpi`, {
            method: "GET"
        });
