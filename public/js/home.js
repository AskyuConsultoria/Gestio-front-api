...
async function buscarUltimos7Pedidos(idUsuario) {
  ...
  try {
    const response = await fetch(`http://192.168.137.199:8080/agendamento/${idUsuario}/ultimos`, {
      method: "GET"
    });
...
async function buscarAgendamentoPorClienteNome(nomeCliente){
  ...
  try{
    const response = await fetch(`http://192.168.137.199:8080/agendamento/filtro-cliente-nome/${usuarioId}?nome=${nomeCliente}`, {
      method: "GET"
    });
...
async function buscarAgendamentoPorClienteEmail(email){
  ...
  try{
    const response = await fetch(`http://192.168.137.199:8080/agendamento/filtro-cliente-email/${usuarioId}?email=${email}`, {
      method: "GET"
    });
...
async function buscarAgendamentoPorPeca(nome){
  ...
  try{
    const response = await fetch(`http://192.168.137.199:8080/pedido-view-agendamento/por-peca/${usuarioId}?nome=${nome}`, {
      method: "GET"
    });
...
async function buscarAgendamentoPorTecido(nome){
  ...
  try{
    const response = await fetch(`http://192.168.137.199:8080/pedido-view-agendamento/por-tecido/${usuarioId}?nome=${nome}`, {
      method: "GET"
    });
