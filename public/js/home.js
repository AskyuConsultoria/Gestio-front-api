...
async function buscarUltimos7Pedidos(idUsuario) {
  ...
  try {
    const response = await fetch(`/askyuagendamento/${idUsuario}/ultimos`, {
      method: "GET"
    });
...
async function buscarAgendamentoPorClienteNome(nomeCliente){
  ...
  try{
    const response = await fetch(`/askyuagendamento/filtro-cliente-nome/${usuarioId}?nome=${nomeCliente}&ativo=true`, {
      method: "GET"
    });
...
async function buscarAgendamentoPorClienteEmail(email){
  ...
  try{
    const response = await fetch(`/askyuagendamento/filtro-cliente-email/${usuarioId}?email=${email}`, {
      method: "GET"
    });
...
async function buscarAgendamentoPorPeca(nome){
  ...
  try{
    const response = await fetch(`/askyupedido-view-agendamento/por-peca/${usuarioId}?nome=${nome}`, {
      method: "GET"
    });
...
async function buscarAgendamentoPorTecido(nome){
  ...
  try{
    const response = await fetch(`/askyupedido-view-agendamento/por-tecido/${usuarioId}?nome=${nome}`, {
      method: "GET"
    });
