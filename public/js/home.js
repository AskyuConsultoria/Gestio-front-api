...
async function buscarUltimos7Pedidos(idUsuario) {
  ...
  try {
    const response = await fetch(`http://10.0.1.226:8080/askyu/agendamento/${idUsuario}/ultimos`, {
      method: "GET"
    });
...
async function buscarAgendamentoPorClienteNome(nomeCliente){
  ...
  try{
    const response = await fetch(`http://10.0.1.226:8080/askyu/agendamento/filtro-cliente-nome/${usuarioId}?nome=${nomeCliente}&ativo=true`, {
      method: "GET"
    });
...
async function buscarAgendamentoPorClienteEmail(email){
  ...
  try{
    const response = await fetch(`http://10.0.1.226:8080/askyu/agendamento/filtro-cliente-email/${usuarioId}?email=${email}`, {
      method: "GET"
    });
...
async function buscarAgendamentoPorPeca(nome){
  ...
  try{
    const response = await fetch(`http://10.0.1.226:8080/askyu/pedido-view-agendamento/por-peca/${usuarioId}?nome=${nome}`, {
      method: "GET"
    });
...
async function buscarAgendamentoPorTecido(nome){
  ...
  try{
    const response = await fetch(`http://10.0.1.226:8080/askyu/pedido-view-agendamento/por-tecido/${usuarioId}?nome=${nome}`, {
      method: "GET"
    });
